...
export const DigitalSolutionsSection: React.FC = () => {
  ...
  return (
    <section id="digital-solutions" className="py-16 md:py-24 bg-slate-900 text-white relative overflow-hidden border-b border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14 space-y-3">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-800 border border-slate-700 text-amber-400 text-xs font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {digitalServices.map((svc, idx) => {
            ...
            return (
              <div
                key={idx}
                className="rounded-3xl bg-slate-800/80 border border-slate-700/80 p-6 sm:p-7 flex flex-col justify-between hover:bg-slate-800 hover:border-amber-500/50 hover:shadow-xl transition-all duration-200"
              >
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-6">
                    {svc.features.map((ft, fIdx) => (
                      <span
                        key={fIdx}
                        className="px-2.5 py-1 rounded-lg text-[10px] font-semibold bg-slate-900/90 text-slate-300 border border-slate-700"
                      >
                        {ft}
                      </span>
                    ))}
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-slate-700/60 hover:bg-amber-500 hover:text-slate-950 text-slate-200 text-xs font-bold border border-slate-600/80 transition-colors flex items-center justify-center gap-2"
                >
          ...
          <div className="rounded-3xl bg-linear-to-br from-amber-600 to-amber-700 text-slate-950 p-6 sm:p-7 flex flex-col justify-between shadow-lg">
